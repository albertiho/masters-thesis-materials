...
from research.training.scripts.validate_eif_mh5_smoke import run_smoke_validation
...
def test_run_smoke_validation_loads_eif_model_and_runs_fast_tuning(tmp_path: Path) -> None:
    ...
    persistence.save_eif(detector, "COMPETITOR_1_COUNTRY_1_mh5", len(X_train))

    output_csv = tmp_path / "results" / "eif_smoke.csv"
